 ...
 * Build: `lodash underscore plus="merge,cloneDeep"`
...
;(function(window) {
  ...
  function filterIndex(collection, callback, thisArg) {
    var result = [];
    callback = createCallback(callback, thisArg);
   ...
   * // => 'nonsense'
   */
  function result(object, property, thisArg) {
    var value = object ? object[property] : null;
    return isFunction(value) ?
      thisArg ? object[property].apply(thisArg, []) : object[property]()
      : value;
  }
  ...
  function toFloat(n) {
    return parseFloat(parseFloat(n).toFixed(lodash.precision || 2));
  }
  ...
  lodash.filterIndex = filterIndex;
